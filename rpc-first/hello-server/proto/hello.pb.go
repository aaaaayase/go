...
const file_hello_proto_rawDesc = "" +
	...
	"\bSayHello\x12)\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\x0e.HelloResponseB\vZ\t.;serviceb\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	1, // 0: SayHello.SayHello:input_type -> HelloRequest
	0, // 1: SayHello.SayHello:output_type -> HelloResponse
